#!/bin/bash
# E14b: DINOv3 freeze 25pct with 6 decoder layers — align decoder depth with R50
set -euo pipefail
...
bash experiments/scripts/run_train.sh \
    experiments/configs/dinov3_freeze_25pct_6layers.yml \
    dinov3_freeze_25pct_6layers \
    "$@"
