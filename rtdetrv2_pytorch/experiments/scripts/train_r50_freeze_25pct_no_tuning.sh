#!/bin/bash
# E12: r50_freeze_25pct without COCO tuning — fair comparison with dinov3_freeze_25pct
...
bash experiments/scripts/run_train.sh \
    experiments/configs/r50_freeze_25pct_no_tuning.yml \
    r50_freeze_25pct_no_tuning \
    "$@"
